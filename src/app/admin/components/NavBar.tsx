...
const NavBar = () => {
  ...
  const handleLogout = async () => {
    ...
    try {
      const res = await fetch('http://localhost:2001/api/user/logout', {
        method: "GET",
        credentials: "include",
      })
      console.log(res)
      ...
      <nav className="app-header navbar navbar-expand bg-body">
        ...
        <div className="container-fluid">
          ...
          <ul className="navbar-nav ms-auto">
            ...
            <li  className={`nav-item dropdown user-menu ${open ? "show" : ""}`}>
              <a href="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown"  onClick={() => setOpen((prev) => !prev)}>
                <img
              ...
              {/* <ul className="dropdown-menu dropdown-menu-lg dropdown-menu-end"  > */}
                  <ul   className={`dropdown-menu dropdown-menu-lg dropdown-menu-end ${open ? "show" : ""
                 }`}>
